...
// 			// $res = sqlsrv_fetch_array($result);
			...
			$query="SELECT * from view_DS_DONHANG where MaND='$MAND' and TrangThai !=1";
			  $result = sqlsrv_query($conn,$query);
...
<?php 
	...
	<a href="account.php"><button type="button" class="btn btn-success">Đăng nhập</button></a> <br>
	<a href="account.php"><button type="button" class="btn btn-link">Tạo tài khoản</button></a></center>
         	';
}
 ?>
